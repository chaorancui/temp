...
**C++11**通过把 POD 概念划分成两个概念：***平凡的（trivial）***和**标准布局*（standard-layout）***，**放宽**了关于 POD 的定义。
...
在 C++11 之前，POD(Plain Old Data) 是一个统一的概念。但在 C++11 及以后，POD 的概念被分解为两个独立的概念：trivial 和 standard-layout。
